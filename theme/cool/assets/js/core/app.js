...
(function(window, document, $) {
    ...
    $('.nav-link-style').on('click', function() {
        ...
        if (currentLayout !== 'dark-layout') {
            ...
            setCookie("read-mode", 'dark-layout'); // Cookie设置
        } else {
            // Switch to light
            switchToLayout = prevLayout ? prevLayout : 'light-layout';
            setCookie("read-mode", 'light-layout'); // Cookie设置
        }
    ...
    function setLayout(currentLocalStorageLayout) {
        ...
        var read_mode = getCookie('read-mode');
        
        if (switchToLayout === 'dark-layout' || read_mode == 'dark-layout') {
            $html.addClass('dark-layout');
            mainMenu.removeClass('menu-light').addClass('menu-dark');
            navbar.removeClass('navbar-light').addClass('navbar-dark');
            navLinkStyle.find('.ficon').replaceWith("<i class='ficon feather icon-sun'></i>");
        }else {
            $html.addClass('light-layout');
            mainMenu.removeClass('menu-dark').addClass('menu-light');
            navbar.removeClass('navbar-dark').addClass('navbar-light');
            navLinkStyle.find('.ficon').replaceWith("<i class='ficon feather icon-moon'></i>");
        }
